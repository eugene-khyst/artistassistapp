/* eslint-disable */
// Generated by Wrangler by running `wrangler types --path=./functions/types.d.ts` (hash: 686c22783db797a85ae18c268801449e)
// Runtime types generated with workerd@1.20260518.1 2026-05-14 
interface __BaseEnv_Env {
	VITE_BUILD_ID: string;
	VITE_PUBLIC_JWK: string;
