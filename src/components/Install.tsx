      ...
      <Row gutter={32}>
        <Col xs={24} md={8}>
          <Typography.Title level={3}>
            ...
            <WindowsOutlined style={{color: colorTextTertiary}} /> Windows,{' '}
            <LinuxOutlined style={{color: colorTextTertiary}} /> Linux and{' '}
            <ChromeOutlined style={{color: colorTextTertiary}} /> ChromeOS
          </Typography.Title>
          <Button
            type="primary"
                ...
                children: (
                  <Typography.Paragraph>
                    <ul>
                      ...
                      <li>
                        <ChromeOutlined style={{color: colorTextTertiary}} /> ChromeOS 76+
                      </li>
                    </ul>
                  </Typography.Paragraph>
                ),
        ...
        <Col xs={24} md={8}>
          <Typography.Title level={3}>
            <AppleOutlined style={{color: colorTextTertiary}} /> iOS and iPadOS
          </Typography.Title>
          ...
          <Typography.Paragraph>Requires iOS 16.4+ or iPadOS 16.4+.</Typography.Paragraph>
        </Col>
        <Col xs={24} md={8}>
          <Typography.Title level={3}>
          ...
          <Typography.Paragraph>Requires macOS Sonoma or later.</Typography.Paragraph>
          <Typography.Paragraph>
            On older versions of macOS, install the latest version of the Chrome, Edge, or Opera web
            browser and click the <Typography.Text code>Install</Typography.Text> button.
          </Typography.Paragraph>
        </Col>
      </Row>
    </div>
