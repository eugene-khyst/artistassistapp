...
const MacOSInstructions: React.FC = () => {
  ...
  return (
    <Space orientation="vertical" size="small">
      ...
      <Typography.Text>
        <Trans>
          Alternatively, install the latest version of Chrome, Edge or Opera web browser and click
          the <Typography.Text strong>Install</Typography.Text> button. In older versions of macOS,
